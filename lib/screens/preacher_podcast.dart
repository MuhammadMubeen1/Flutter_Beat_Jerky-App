...
class _AudioPlayState extends State<AudioPlay> {
  ...
  void _init() async {
    ...
    await _audioPlayer.setUrl(widget.song.fileURL.replaceAll('public', ApiConstants.baseUrl));
  ...
  void seekForward(){
    ...
    _audioPlayer.seek(Duration(seconds:progressNotifier.value.current.inSeconds+10));
            ...
            children: [
                  ...
                  children: [
                    ClipRRect(
                      ...
                      Image.network(widget.song.coverImageURL!.replaceAll('public', ApiConstants.baseUrl),
                        height: Get.height * 0.4,
                        width: Get.width * 0.9,):Image.asset(
                    ...
                    child: ValueListenableBuilder<ProgressBarState>(
                      ...
                      builder: (__, value, _) {
                        return ProgressBar(
                          ...
                          thumbGlowColor: Colors.purpleAccent,
                          onSeek: seek,
                        );
                      },
                    ),
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                      onTap: seekBackward,
                      child: Icon(Icons.replay_10,color: greyColor,size: 30,)),
                  Container(
                    width: 50.0,
                    height: 50.0,
                    alignment: Alignment.center,
                  ...
                  //       gradient: buttonGradient,
                  //     ),
                  //     child: true?const Icon(Icons.pause,color: whiteColor,size: 40,):const Icon(Icons.play_arrow,color: whiteColor,size: 40,),
                  //   ),
                  // ),
                  InkWell(
                      onTap: seekForward,
                      child: Icon(Icons.forward_10,color: greyColor,size: 30,)),
